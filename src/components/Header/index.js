...
class Header extends Component {
  ...
  onChangeSearchQueryInput = event => {
              ...
              <Navbar dark={isDark}>
                <NavContent>
                  <NavContainer>
                    ...
                    <HeaderMenuButton
                      onClick={this.onClickHamburgerMenuView}
                      type="button"
                    >
                  ...
                  <NavMenuLg>
                    <HeaderSearchContainerLg dark={isDark}>
                      <HeaderSearchInput
                        ...
                        placeholder="Search Caption"
                        value={searchQuery}
                        onChange={this.onChangeSearchQueryInput}
                      />
                      <HeaderSearchButton
                        type="button"
                        onClick={this.onClickSearchButton}
                    ...
                    <NavItem>
                      <Link
                        className={`nav-link ${
                          this.getActiveRoutePath() === '/' && 'active-menu'
                        }`}
                        to="/"
                      >
                        Home
                    ...
                    <NavItem>
                      <Link
                        className={`nav-link ${
                          this.getActiveRoutePath() === '/my-profile' &&
                          'active-menu'
                        }`}
                        to="/my-profile"
                      >
